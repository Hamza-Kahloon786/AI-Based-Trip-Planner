        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
          ...
          <div className="p-8 space-y-8 text-gray-700">
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Information We Collect</h2>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">How We Use Your Information</h2>
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Data Sharing</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">AI Processing</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Cookies and Similar Technologies</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Security</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Third-Party Links and Vendors</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Retention</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">International Transfers</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Children’s Privacy</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Your Choices</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Changes to This Policy</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-3">
              <h2 className="font-display text-2xl font-bold text-slate-800">Contact</h2>
              <p className="text-gray-600">
