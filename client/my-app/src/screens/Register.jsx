    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex lg:w-5/12 xl:w-[45%] bg-indigo-600 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-display text-4xl font-extrabold text-white leading-tight mb-3">
            ...
            <span className="bg-gradient-to-r from-indigo-200 to-emerald-200 bg-clip-text text-transparent">starts here.</span>
          </h2>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="font-display text-3xl font-extrabold text-slate-900 tracking-tight mb-2">Create your account</h1>
